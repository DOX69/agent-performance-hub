...
```bash
aph list                      # Browse all 274 skills
...
| `aph list` | List all available skills (274) |
...
- **274 skills** across 12 categories
...
**Last updated**: 2026-03-16 | See [CHANGELOG.md](CHANGELOG.md) for version history.
